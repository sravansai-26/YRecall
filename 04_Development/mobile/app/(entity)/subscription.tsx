...
export default function SubscriptionEntity() {
 ...
 {/* Monthly Cost */}
 <View className="flex-1 bg-white p-lg rounded-[24px] shadow-sm border-surface-variant flex-col justify-between">
 <View>
 ...
 {/* Payment Method */}
 <View className="bg-white p-lg rounded-[24px] shadow-sm border-surface-variant flex-row items-center justify-between">
 <View>
 ...
 {/* AI Usage Analysis */}
 <View className="bg-white p-lg rounded-[24px] shadow-sm border-secondary/20 relative overflow-hidden flex-col gap-4">
 ...
 <View className="flex-col gap-4">
 <View className="flex-row items-center justify-center p-4 bg-background rounded-xl border-secondary-container/30">
 ...
 {/* Controls & Settings */}
 <View className="bg-white p-lg rounded-[24px] shadow-sm border-surface-variant flex-col gap-4">
 ...
 {/* Danger Zone */}
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full py-4 rounded-[24px] border-error/20 bg-error/5 flex-row items-center justify-center gap-2">

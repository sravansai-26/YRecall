...
export default function PlaceProfile() {
 ...
 {/* Location & Weather */}
 <View className="bg-white rounded-[24px] p-lg shadow-sm ">
 ...
 <View className="bg-surface-container rounded-[24px] p-lg mt-4">
 ...
 <View className="bg-white px-4 py-2 rounded-full flex-row items-center gap-2">

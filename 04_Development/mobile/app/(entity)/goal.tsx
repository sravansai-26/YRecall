...
export default function GoalEntity() {
 ...
 {/* Hero Progress Card */}
 <View className="bg-surface-container-lowest rounded-[24px] p-xl shadow-sm flex-col relative overflow-hidden min-h-[300px]">
 ...
 {/* Milestones Section */}
 <View className="bg-surface-container rounded-[24px] p-xl flex-col gap-6">
 ...
 {/* Voice Memo */}
 <View className="flex-1 bg-surface-container-high rounded-xl items-center justify-center p-4">
 ...
 <View className="bg-tertiary-container rounded-[24px] p-lg flex-row gap-4 items-start border-tertiary-fixed/30 relative overflow-hidden mt-4">

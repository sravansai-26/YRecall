...
export default function ProjectProfile() {
 ...
 <View className="bg-white rounded-[24px] p-lg shadow-sm border-surface-container-highest flex-col justify-between">
 <View>
 ...
 <View className="absolute left-0 top-1 w-4 h-4 rounded-full bg-primary border-[4px] z-10" />
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-row items-center gap-4 p-3 rounded-xl ">
 ...
 <View className="flex-col gap-2">
 <View className="bg-primary-container p-4 rounded-xl border-on-primary-container/20">

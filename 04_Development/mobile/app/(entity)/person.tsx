...
export default function PersonProfile() {
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="bg-white px-8 h-14 rounded-xl flex-row items-center justify-center gap-2 shadow-sm ">
 ...
 {/* Key Context Card */}
 <View className="bg-white rounded-[24px] p-lg shadow-sm border-surface-container-highest">
 ...
 <View className="p-md bg-surface-container-low rounded-2xl ">
 ...
 <View className="bg-white rounded-[24px] p-lg shadow-sm border-surface-container-highest mt-lg">
 <View className="flex-row items-center gap-3 mb-xl">
 ...
 <View className="bg-white px-3 py-1 rounded-full "><Text className="text-xs text-on-surface-variant">Zoom Recording</Text></View>
 <View className="bg-white px-3 py-1 rounded-full "><Text className="text-xs text-on-surface-variant">3 Participants</Text></View>
 </View>
 </TouchableOpacity>
 </View>
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-1 bg-white p-md rounded-2xl border-surface-container-highest shadow-sm">
 <View className="flex-row justify-between mb-1">
 <View className="flex-row items-center gap-2">

...
export default function HabitEntity() {
 ...
 <View className="w-10 h-10 rounded-full bg-surface-variant overflow-hidden ">
 ...
 {/* Habit Identity Card */}
 <View className="bg-white rounded-[24px] p-xl shadow-sm relative overflow-hidden">
 ...
 <View className="bg-white rounded-[24px] p-xl shadow-sm ">
 ...
 <View className="flex-col gap-4">
 {/* Entry Card 1 */}
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="bg-white rounded-[24px] p-lg shadow-sm ">

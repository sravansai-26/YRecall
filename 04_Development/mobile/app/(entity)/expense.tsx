...
export default function ExpenseEntity() {
 ...
 {/* Transaction Header */}
 <View className="bg-surface-container-lowest rounded-[24px] p-lg shadow-sm border-surface-container flex-col gap-4">
 ...
 {/* Receipt Image */}
 <View className="bg-surface-container-lowest rounded-[24px] p-lg shadow-sm border-surface-container h-[400px]">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full py-3 border-2 border-dashed rounded-xl flex-row items-center justify-center gap-2">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full h-14 border-error rounded-xl flex-row items-center justify-center gap-2 mt-2">

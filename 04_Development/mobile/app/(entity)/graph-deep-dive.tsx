...
export default function KnowledgeGraphDeepDive() {
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="h-14 px-lg bg-surface-container rounded-xl flex-row items-center justify-center gap-sm flex-1">
 ...
 <View className="w-full aspect-square rounded-[24px] bg-surface-container-low shadow-sm relative overflow-hidden mb-xl">
 <View className="absolute top-1/2 left-1/2 -mt-16 -ml-16 z-20">
 <View className="w-32 h-32 rounded-full bg-primary items-center justify-center shadow-xl border-4 ">
 <Text className="font-bold text-white text-center">Project{'\n'}Nova</Text>
 </View>
 </View>
 {/* Orbiting Nodes */}
 <View className="absolute top-[20%] left-[10%] z-10 bg-white/70 px-4 py-2 rounded-full flex-row items-center gap-2 shadow-sm">
 ...
 <View className="absolute top-[30%] right-[10%] z-10 bg-white/70 px-4 py-2 rounded-full flex-row items-center gap-2 shadow-sm">
 <MaterialIcons name="map" size={16} color={colors.secondary} />
 <Text className="font-bold text-primary text-xs">Q3 Roadmap</Text>
 </View>
 <View className="absolute bottom-[20%] left-[20%] z-10 bg-white/70 px-4 py-2 rounded-full flex-row items-center gap-2 shadow-sm">
 ...
 {/* Voice Note Memory */}
 <View className="bg-white rounded-[24px] p-lg shadow-sm flex-col gap-md">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full py-3 rounded-xl border-outline items-center justify-center">

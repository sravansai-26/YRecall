...
export default function WorkspaceSettingsScreen() {
 ...
 return (
 <Screen>
 <View className="flex-row items-center p-4 bg-surface">
 ...
 <View className="bg-surface p-3 rounded-lg flex-row items-center justify-between ">
 ...
 <View key={member.id} className="flex-row items-center justify-between bg-surface p-3 rounded-xl ">

...
export default function SearchFilters() {
 ...
 <View className="w-full bg-surface-container-lowest z-40 px-margin-mobile py-sm h-16 flex-row items-center justify-between ">
 ...
 <View className="items-center gap-xs">
 <View className="w-16 h-16 rounded-full border-2 border-dashed items-center justify-center bg-surface-container-lowest">
 ...
 <View className="bg-surface-variant/20 p-md rounded-2xl flex-row items-center justify-between ">
 <View className="flex-row items-center gap-sm">
 ...
 {/* Footer */}
 <View className="p-lg bg-surface border-t flex-row items-center gap-md absolute bottom-0 left-0 w-full z-50">

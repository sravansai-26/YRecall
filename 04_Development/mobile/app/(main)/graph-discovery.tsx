...
export default function KnowledgeGraphDiscovery() {
 ...
 <View className="w-24 h-24 rounded-full bg-white items-center justify-center shadow-md border-secondary-container/30">
 ...
 <View className="absolute -top-12 -right-8 p-sm bg-white rounded-xl shadow-sm flex-row items-center gap-xs">
 ...
 <View className="w-28 h-28 rounded-full bg-white items-center justify-center shadow-md border-tertiary-fixed/30">
 ...
 <View className="absolute -bottom-10 right-0 p-sm bg-white rounded-xl shadow-sm flex-row items-center gap-xs">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-14 h-14 rounded-2xl bg-white shadow-xl items-center justify-center">
 ...
 {/* View Controls */}
 <View className="absolute bottom-6 left-1/2 -ml-[120px] bg-white/70 p-1 rounded-full flex-row gap-1 z-30 ">

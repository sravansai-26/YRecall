      ...
      <View className="flex-row flex-wrap gap-2">
        {options.map((opt: {id: string, label: string}) => (
          <TouchableOpacity 
            ...
            className={`px-4 py-2 rounded-full border ${value === opt.id ? 'bg-primary border-primary' : 'bg-surface-container-lowest border-outline-variant/30'}`}
          >
      ...
      <View className="max-w-2xl mx-auto px-margin-mobile w-full pb-20">
        ...
        <View className="bg-surface-container-lowest p-4 rounded-2xl border border-outline-variant/20">
          ...
          <TouchableOpacity 
            ...
            className="flex-row items-center justify-between bg-surface-container-low p-4 rounded-xl border border-outline-variant/30"
          >
          ...
          {showLanguageModal && (
            <View className="mt-4 max-h-64 rounded-xl border border-outline-variant/30 overflow-hidden">
              <ScrollView nestedScrollEnabled className="bg-surface-container-lowest">
                {SUPPORTED_LANGUAGES.map((lang) => (
                  <TouchableOpacity
                    ...
                    className={`flex-row justify-between items-center p-4 border-b border-outline-variant/10 ${form.language === lang.code ? 'bg-primary/5' : ''}`}
                  >
                    <View>

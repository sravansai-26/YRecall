...
export default function StorageSyncDashboard() {
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-1 p-6 rounded-[24px] bg-white shadow-sm flex-col justify-between">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-1 p-6 rounded-[24px] bg-white flex-col items-center justify-center gap-4 ">
 ...
 <View className="h-[400px] rounded-[32px] overflow-hidden relative shadow-sm bg-surface-container-high justify-end p-6 md:p-8">

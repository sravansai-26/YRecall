...
export default function AIPersonalization() {
 ...
 <View className="bg-surface-container-lowest rounded-2xl p-5 shadow-sm flex-col">
 ...
 {/* Input Area */}
 <View className="flex-row items-center rounded-xl bg-surface pl-4 pr-2 h-12 mb-5">
 ...
 <View className="w-full py-6 items-center justify-center border-dashed rounded-xl bg-surface-container-lowest">
 <Text className="text-sm text-on-surface-variant italic">No focus topics defined yet.</Text>
 </View>
 ) : (
 (form.interests || []).map((interest: string) => (
 <View key={interest} className="bg-secondary-container px-3 py-2 rounded-xl flex-row items-center gap-2 shadow-sm">
 ...
 className="flex-row items-center justify-between p-4 bg-error/10 border-error/20 rounded-xl"
 >

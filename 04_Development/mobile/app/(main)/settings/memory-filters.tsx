...
export default function MemoryFiltersSettings() {
 ...
 className="flex-row items-center justify-between mt-6 mb-2 bg-surface-container-lowest p-4 rounded-2xl shadow-sm"
 >
 ...
 className={`px-4 py-2 rounded-full ${value === opt ? 'bg-primary border-primary' : 'bg-surface-container-lowest '}`}
 >
 ...
 <View key={stat.label} className="flex-1 min-w-[80px] bg-surface-container-low p-3 rounded-xl shadow-sm items-center">
 ...
 <View className="bg-surface-container-lowest rounded-2xl p-5 mb-4 shadow-sm animate-fade-in">
 ...
 className={`px-3 py-2 rounded-lg ${form.active_preset?.toLowerCase() === preset.toLowerCase() ? 'bg-secondary/10 border-secondary' : 'bg-surface '}`}
 >
 ...
 className={`px-3 py-1.5 rounded-full flex-row items-center gap-1 ${isActive ? 'bg-primary border-primary' : 'bg-surface-container-highest border-transparent'}`}
 >

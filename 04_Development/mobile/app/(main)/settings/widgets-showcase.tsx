...
export default function WidgetsShowcase() {
 ...
 {/* Large Widget */}
 <View className="w-full bg-white/70 rounded-[28px] p-4 mb-4 shadow-sm border-white flex-col gap-3">
 ...
 <View className="p-3 bg-secondary/10 rounded-xl border-secondary/20 flex-col gap-1">
 ...
 {/* Small Widget 1 */}
 <View className="flex-1 aspect-square bg-white/70 rounded-[28px] p-4 shadow-sm border-white flex-col justify-between">
 ...
 {/* Medium Widget */}
 <View className="w-full bg-surface-container-lowest/80 rounded-[28px] p-4 mb-4 shadow-sm flex-col">

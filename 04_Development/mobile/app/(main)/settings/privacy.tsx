...
export default function SecurityPrivacyDashboard() {
 ...
 <View className="mb-4 flex-row items-center justify-center gap-2 bg-secondary-container/20 px-4 py-2 rounded-full border-secondary/30 self-center md:self-start">
 ...
 <View className="flex-row items-center gap-3 bg-white/10 px-4 py-3 rounded-xl border-white/10">
 ...
 <View className="bg-white/80 rounded-[24px] overflow-hidden shadow-sm ">
 ...
 {/* Data Retention Card */}
 <View className="bg-surface-container-lowest rounded-[24px] p-6 shadow-sm ">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full mt-6 py-3 rounded-xl items-center justify-center">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full py-3 bg-white/10 border-white/20 rounded-xl items-center justify-center">
 ...
 <View className="bg-secondary-container/20 border-secondary/20 p-6 rounded-[24px] flex-row items-start gap-4 flex-1">

...
export default function ImportSyncHub() {
 ...
 <TextInput 
 className="w-full h-14 pl-12 pr-4 bg-surface-container-low rounded-xl font-body-md text-base text-on-surface" 
 ...
 <View className="w-full md:flex-1 bg-white/70 p-6 rounded-[24px] shadow-sm border-white flex-col justify-between">
 ...
 <View className="w-full md:flex-1 bg-white/70 p-6 rounded-[24px] shadow-sm border-error/20 flex-col justify-between">
 <View className="flex-row justify-between items-start mb-12">
 <View className="w-14 h-14 bg-white rounded-2xl items-center justify-center shadow-sm">
 ...
 <View className="w-full md:w-[65%] lg:w-[66%] bg-white/70 p-6 rounded-[24px] shadow-sm border-white flex-col md:flex-row gap-6 items-center overflow-hidden relative">
 ...
 <View className="w-48 h-48 items-center justify-center bg-primary/20 rounded-full shrink-0">

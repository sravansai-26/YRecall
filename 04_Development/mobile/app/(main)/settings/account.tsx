...
export default function AccountSettings() {
 ...
 {/* Export Card */}
 <View className="flex-[1.5] min-w-[300px] p-8 bg-surface-container-lowest rounded-2xl flex-col gap-4 relative overflow-hidden group shadow-sm">
 ...
 {/* Intelligence Status */}
 <View className="flex-1 min-w-[250px] p-8 bg-surface-container rounded-2xl flex-col justify-between">
 ...
 <View className="w-full rounded-2xl overflow-hidden bg-surface-container-lowest shadow-sm flex-col">
 <View className="p-4 bg-surface-container-low">
 <Text className="font-headline-md text-xl font-bold text-on-surface">Data Treatment Policy</Text>
 </View>
 <View className="flex-col md:flex-row">
 <View className="p-6 md:border-b-0 md:border-r flex-1 flex-col">
 ...
 {/* The Wipe Mechanism */}
 <View className="bg-surface p-8 rounded-2xl flex-col gap-6 shadow-sm">
 ...
 className={`w-full bg-surface-container-lowest ${eraseText === 'ERASE PERMANENTLY' ? 'border-error' : ''} px-4 py-3 rounded-xl font-bold text-base text-on-surface `}
 ...
 <View className="mt-8 border-t pt-6 flex-col md:flex-row justify-between items-center gap-4">

...
export default function IdentitySecurityCenterScreen() {
 ...
 {/* Header */}
 <View className="w-full sticky top-0 z-50 bg-surface/90 flex-row items-center justify-between px-margin-mobile h-16 md:px-margin-desktop ">
 ...
 <View className="bg-surface-container-lowest rounded-3xl p-2 shadow-sm mb-8">
 ...
 className={`px-4 py-2 rounded-full ${isActive ? 'bg-primary border-primary' : 'bg-transparent '}`}
 >
 ...
 <View key={session.id} className="bg-surface-container-lowest rounded-2xl p-4 shadow-sm mb-3 flex-row items-center justify-between">
 <View className="flex-row items-center gap-3">
 ...
 className="px-3 py-1.5 bg-error/10 rounded-full border-error/20"
 >
 ...
 <View className="bg-surface-container-lowest rounded-3xl p-4 shadow-sm mb-8">
 {loadingLogs ? (
 <ActivityIndicator />
 ) : logs && logs.length > 0 ? (

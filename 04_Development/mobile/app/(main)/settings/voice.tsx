...
export default function VoiceIntelligenceCenter() {
 ...
 {/* 1. Voice Overview */}
 <View className="bg-surface-container-lowest rounded-2xl p-5 shadow-sm mt-6 flex-row flex-wrap gap-4">
 ...
 <View className="mt-8 pt-6 border-t border-transparent flex-col md:flex-row items-center justify-between gap-4">

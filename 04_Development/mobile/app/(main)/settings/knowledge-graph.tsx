...
export default function KnowledgeGraphSettings() {
 ...
 <View className="bg-surface-container-lowest rounded-2xl p-4 flex-1 min-w-[45%] mb-4 mr-4">
 ...
 className={`flex-row items-center justify-between p-4 rounded-2xl mb-3 ${isRunning ? 'bg-surface-container ' : 'bg-surface-container-lowest '}`}
 >
 ...
 <View className="px-3 py-1 rounded-full bg-green-500/10 border-green-500/20">
 ...
 <View className="bg-surface-container-lowest rounded-[24px] px-6 py-2 shadow-sm mb-8">
 <SettingToggle 

...
export default function SensorSettings() {
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="px-4 py-2 rounded-xl bg-white">
 ...
 <View className="w-full md:w-[35%] xl:w-[30%] bg-white/70 p-6 rounded-[24px] shadow-sm flex-col gap-4 min-w-[280px]">
 ...
 <View className="flex-1 bg-white/70 p-6 rounded-[24px] shadow-sm relative overflow-hidden flex-col justify-between min-w-[320px]">
 ...
 <View className=" p-3 rounded-xl bg-surface/50 flex-1 min-w-[100px]">
 ...
 {/* Contextual Shushing */}
 <View className="flex-[1.5] min-w-[320px] bg-white/70 p-6 rounded-[24px] shadow-sm flex-col">
 ...
 {/* Rule 1 */}
 <View className="flex-row items-center justify-between p-4 bg-surface rounded-xl transition-colors group">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full mt-4 py-3 border-2 border-dashed rounded-xl items-center justify-center transition-all">
 <Text className="font-bold text-[10px] text-on-surface-variant uppercase tracking-widest">+ Add New Custom Boundary</Text>
 </TouchableOpacity>
 </View>

 {/* Biometric Streams */}
 <View className="flex-1 min-w-[280px] bg-white/70 p-6 rounded-[24px] shadow-sm flex-col gap-6">
 ...
 <View className="mt-auto p-4 bg-surface-container-low rounded-xl ">
 ...
 {/* App Usage & Focus */}
 <View className="w-full bg-white/70 p-6 rounded-[24px] shadow-sm flex-col md:flex-row justify-between gap-6">
 ...
 <View className="flex-1 p-4 rounded-xl flex-row items-center justify-between bg-surface/50">
 <View className="flex-row items-center gap-3">
 ...
 <View className="w-full md:w-64 flex-col justify-center items-center p-6 border-t md:border-t-0 md:border-l md:pl-10">

...
export default function SearchResults() {
 ...
 <View className="bg-white/80 rounded-[24px] p-lg border-secondary/30 shadow-sm">
 ...
 <View className="px-3 py-1 bg-secondary/10 border-secondary/20 rounded-full">
 ...
 <TouchableOpacity onPress={() => router.push('/(entity)/project')} className="flex-1 bg-surface-container-lowest rounded-[24px] p-lg shadow-sm mb-4">
 ...
 {/* Timeline Event */}
 <TouchableOpacity onPress={() => router.push('/(insight)/detail')} className="flex-1 bg-surface-container-lowest rounded-[24px] p-lg shadow-sm mb-4">
 <View className="flex-row items-start justify-between mb-lg">

...
export default function MemoryDetailScreen() {
 ...
 <View className="bg-surface-variant px-3 py-1.5 rounded-full flex-row items-center gap-1.5 ">
 ...
 <View className="mb-6 pt-6 border-t border-transparent">
 ...
 className="w-64 bg-surface-container-low p-4 rounded-2xl mr-4 shadow-sm"
 >
 ...
 className="flex-row items-center p-4 bg-surface-container rounded-xl mb-3 "
 >

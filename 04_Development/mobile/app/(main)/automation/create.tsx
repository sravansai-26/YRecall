...
export default function CreateAutomationScreen() {
 ...
 {/* Header */}
 <View className="bg-surface z-50 h-16 w-full flex-row items-center px-margin-mobile ">
 ...
 className="bg-surface-container-lowest p-5 rounded-2xl flex-row items-center shadow-sm"
 >
 ...
 <TouchableOpacity 
 onPress={() => setStep(2)}
 className="bg-surface-container border-dashed p-6 rounded-2xl items-center"
 >
 ...
 <View className="bg-surface-container-lowest p-6 rounded-3xl mb-6 shadow-sm">
 <Text className="font-label-md text-primary font-bold uppercase mb-4 tracking-wider">1. Trigger (When...)</Text>
 <View className="bg-surface-container h-12 rounded-xl justify-center px-4 mb-2 ">
 ...
 className="bg-surface-container-lowest font-body-lg text-on-surface p-4 rounded-xl focus:border-primary shadow-sm"
 />
 </View>

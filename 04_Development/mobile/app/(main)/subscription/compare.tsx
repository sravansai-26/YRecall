...
export default function FeatureComparison() {
 ...
 {/* Free Plan */}
 <View className="flex-1 bg-white rounded-[24px] p-8 shadow-sm flex-col min-w-[300px]">
 <View className="mb-8">
 ...
 <View className="flex-1 bg-white/70 p-6 rounded-[24px] shadow-sm flex-col items-center text-center">
 ...
 <View className="hidden md:flex flex-col bg-white rounded-[24px] shadow-sm overflow-hidden mb-8">
 <View className="px-8 py-6 bg-surface-container/50 flex-row justify-between items-center ">

...
export default function PremiumUpgradeHub() {
 ...
 {/* TopAppBar */}
 <View className="w-full sticky top-0 z-50 bg-[#FCFAF7]/90 flex-row items-center justify-between px-margin-mobile md:px-margin-desktop h-16 ">
 ...
 <View className="flex-[1.5] bg-white p-8 rounded-[24px] shadow-sm flex-col justify-between ">
 ...
 <TouchableOpacity 
 className="flex-1 bg-surface-container p-6 rounded-[24px] shadow-sm flex-row items-center justify-between "
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-1 bg-surface-container p-6 rounded-[24px] shadow-sm flex-row items-center justify-between ">
 <View className="flex-col">
 ...
 {/* Trust Section */}
 <View className="mt-8 pt-8 border-t flex-col md:flex-row justify-between items-center gap-8">
 ...
 <View className="bg-white p-6 rounded-2xl shadow-sm max-w-sm flex-1">

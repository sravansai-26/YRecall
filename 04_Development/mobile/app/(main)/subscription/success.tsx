...
export default function PremiumSuccess() {
 ...
 <View className="w-full h-full rounded-full border-secondary/20 items-center justify-center p-4 bg-surface-container-lowest shadow-lg overflow-hidden relative">

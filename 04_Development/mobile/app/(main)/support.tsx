...
export default function SupportHub() {
 ...
 className="w-full h-14 pl-12 pr-4 bg-surface rounded-xl border-[#D1CDC7] font-body-md text-base text-on-surface shadow-sm "
 placeholderTextColor={colors.outline}
 />
 </View>
 <View className="flex-row flex-wrap justify-center gap-2">
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="px-3 py-1.5 bg-secondary-container/20 rounded-full border-secondary-container/30">
 ...
 {/* Tutorials Bento */}
 <View className="bg-white rounded-[24px] p-6 shadow-sm border-[#006e6e]/20 flex-col">
 ...
 {/* FAQs Accordion */}
 <View className="bg-white rounded-[24px] p-6 shadow-sm flex-col">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full h-14 border-white/30 rounded-xl flex-row items-center justify-center gap-2 ">
 ...
 <View className="w-full h-12 bg-surface border-[#D1CDC7] rounded-lg px-3 justify-center">
 ...
 <TextInput 
 className="w-full h-24 bg-surface border-[#D1CDC7] rounded-lg p-3 text-on-surface font-body-md"
 ...
 {/* Community Help */}
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="bg-white rounded-[24px] p-6 shadow-sm flex-row items-center justify-between ">
 <View className="flex-col">

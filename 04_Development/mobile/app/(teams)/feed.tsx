...
export default function Feed() {
 ...
 <View className="hidden lg:flex flex-col w-[280px] p-4 gap-2 border-r bg-surface-container-low h-full">
 ...
 <View className="mt-auto pt-6 border-t ">
 ...
 <View className="mb-10 p-6 rounded-2xl bg-white/80 ">
 ...
 <View className="mt-4 pt-4 border-t flex-row items-center justify-between">
 ...
 <View className="p-6 bg-surface-container-low rounded-2xl shadow-sm">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full mt-6 py-2 rounded items-center">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-row items-center gap-3 p-3 rounded-lg bg-surface-bright">
 ...
 <View className="flex-row items-center gap-2 px-2 py-1 rounded bg-white shadow-sm ">

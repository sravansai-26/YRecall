...
export default function TeamsIdentity() {
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-32 h-32 rounded-3xl bg-surface-container-low border-2 border-dashed flex-col items-center justify-center">
 ...
 <TouchableOpacity 
 key={purpose.id}
 className={`w-[47%] p-4 rounded-xl ${isSelected ? 'border-secondary bg-secondary-container/30' : ' bg-surface-container-lowest'} flex-col gap-2 items-start`}

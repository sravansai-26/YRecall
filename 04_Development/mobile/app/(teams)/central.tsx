...
export default function TeamsCentral() {
 ...
 {/* Activity Feed */}
 <View className="flex-col md:w-[60%] bg-surface-container-lowest rounded-[24px] p-6 shadow-sm h-[520px]">
 ...
 {/* Highlighted Item */}
 <View className="bg-secondary-container/30 border-secondary/10 p-4 rounded-xl flex-row items-start gap-4">
 ...
 <View className="flex-col flex-1 bg-primary-container rounded-[24px] p-6 shadow-sm h-[520px]">
 <View className="mb-6">
 ...
 <View className="flex-1 bg-primary/20 rounded-xl border-white/10 items-center justify-center">
 <View className="w-24 h-24 rounded-full border-secondary-fixed/50 items-center justify-center bg-primary/40">
 ...
 <View className="flex-1 bg-white/10 p-3 rounded-lg border-white/10">
 ...
 {/* Members */}
 <View className="flex-col md:w-[35%] bg-surface-container-lowest rounded-[24px] p-6 shadow-sm ">
 ...
 <View className="pt-4 mt-4 border-t ">
 ...
 <View className="w-60 bg-surface-container-lowest p-4 rounded-2xl shadow-sm mr-4">
 ...
 <View className="w-60 bg-surface-container-lowest p-4 rounded-2xl shadow-sm ">

...
export default function DiscoveryHub() {
 ...
 {/* TopAppBar */}
 <View className="w-full top-0 sticky z-50 bg-surface-container shadow-sm h-16 px-4 md:px-margin-desktop flex-row justify-between items-center">
 ...
 <View className="relative bg-white rounded-xl shadow-sm ">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-row items-center bg-surface-container-low px-3 py-1.5 rounded-lg gap-2">
 ...
 <View className="bg-white p-4 rounded-xl shadow-sm shadow-[rgba(0,106,106,0.1)_0px_4px_12px]">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full py-2 rounded-lg items-center">
 <Text className="font-label-xs text-primary uppercase tracking-widest">View Cluster</Text>
 </TouchableOpacity>
 </View>

 <View className="h-48 rounded-xl overflow-hidden relative bg-primary/10">
 ...
 <View className="flex-1 min-w-[200px] bg-surface-container-low p-4 rounded-xl ">
 ...
 <View className="w-full h-40 bg-white rounded-xl overflow-hidden relative">
 ...
 {/* Expert Discovery */}
 <View className="lg:w-[30%] bg-white rounded-2xl p-6 shadow-sm">
 <View className="mb-8">

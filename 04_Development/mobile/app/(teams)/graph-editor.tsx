...
export default function GraphEditor() {
 ...
 {/* Sidebar */}
 <View className="hidden lg:flex w-[280px] bg-surface-container-low border-r z-40 flex-col">
 <View className="p-6 ">
 ...
 <View className="p-3 bg-surface rounded-xl ">
 ...
 <View className="bg-surface-bright px-3 py-1 rounded-full flex-row items-center gap-1">
 ...
 <View className="absolute bottom-6 left-6 flex-row items-center gap-2 bg-primary/40 px-3 py-1.5 rounded-full border-white/10">
 ...
 <View className="w-16 h-16 bg-white/5 border-white/20 rounded-xl items-center justify-center mb-2">
 ...
 <View className="w-14 h-14 bg-white/5 border-white/20 rounded-xl items-center justify-center mb-2">
 ...
 <View className="w-20 h-20 bg-white/5 border-white/20 rounded-xl items-center justify-center mb-2">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-12 h-12 bg-primary/80 border-white/10 rounded-full items-center justify-center">

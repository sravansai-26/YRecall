...
export default function TeamsSharedSetup() {
 ...
 <View className="fixed top-0 w-full z-50 bg-surface/90 h-16 flex-row justify-between items-center px-margin-mobile ">
 ...
 <View className="w-10 h-10 rounded-full bg-surface-container-highest flex items-center justify-center overflow-hidden ">
 <Image 
 ...
 <View className="p-6 rounded-[24px] bg-white shadow-sm border-surface-container-highest">
 ...
 <TouchableOpacity 
 className={`p-4 rounded-xl flex-row items-start gap-3 ${selectedLayer === 'shared' ? 'bg-primary-container/10 border-primary' : 'bg-transparent '}`}
 onPress={() => setSelectedLayer('shared')}
 >
 <View className={`w-5 h-5 rounded-full border-2 items-center justify-center mt-0.5 ${selectedLayer === 'shared' ? 'border-primary' : ''}`}>
 ...
 <TouchableOpacity 
 className={`p-4 rounded-xl flex-row items-start gap-3 ${selectedLayer === 'private' ? 'bg-primary-container/10 border-primary' : 'bg-transparent '}`}
 onPress={() => setSelectedLayer('private')}
 >
 <View className={`w-5 h-5 rounded-full border-2 items-center justify-center mt-0.5 ${selectedLayer === 'private' ? 'border-primary' : ''}`}>
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-1 p-4 rounded-2xl flex-col items-center justify-center ">
 ...
 {/* Action Card */}
 <View className="p-6 rounded-[24px] bg-secondary-container/30 border-secondary-fixed flex-col gap-6">
 <View>

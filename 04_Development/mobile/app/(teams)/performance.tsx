...
export default function Performance() {
 ...
 {/* TopAppBar */}
 <View className="w-full top-0 sticky z-40 bg-surface-container shadow-sm h-16 px-4 md:px-margin-desktop flex-row justify-between items-center">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="px-3 py-1.5 rounded flex-row items-center gap-1">
 ...
 <View className="flex-1 bg-surface-container-lowest p-6 rounded-xl shadow-sm flex-col justify-between">
 ...
 <View className="mt-4 border-t pt-4 flex-row justify-between">
 ...
 <View className="flex-1 bg-primary p-6 rounded-xl border-primary-container shadow-lg flex-col justify-between relative overflow-hidden">
 ...
 <View className="mt-4 border-t pt-4 flex-col">
 ...
 <View className="flex-[2] bg-white rounded-xl p-8 shadow-sm flex-col">
 ...
 <View className="h-64 w-full flex-row items-end gap-1 px-2 border-l relative">
 ...
 <View className="flex-[1] bg-surface-container-low rounded-xl p-8 flex-col">
 ...
 <View className="flex-1 bg-white rounded-xl p-6 shadow-sm flex-col">
 ...
 <View className="bg-secondary-container px-3 py-1 rounded-full flex-row items-center gap-1 border-secondary/10"><Text className="text-on-secondary-container text-body-sm font-bold">#CloudNative</Text><Text className="text-[10px] text-on-secondary-container opacity-70">x42</Text></View>
 <View className="bg-surface-container-high px-3 py-1 rounded-full flex-row items-center gap-1 "><Text className="text-primary text-body-sm font-bold">#RustCore</Text><Text className="text-[10px] text-primary opacity-70">x38</Text></View>
 <View className="bg-surface-container-high px-3 py-1 rounded-full flex-row items-center gap-1 "><Text className="text-primary text-body-sm font-bold">#VectorSearch</Text><Text className="text-[10px] text-primary opacity-70">x31</Text></View>
 <View className="bg-surface-container-high px-3 py-1 rounded-full flex-row items-center gap-1 "><Text className="text-primary text-body-sm font-bold">#LatencyReduction</Text><Text className="text-[10px] text-primary opacity-70">x29</Text></View>
 </View>
 ...
 <View className="flex-row items-center justify-between">
 <View className="flex-row items-center gap-3">
 <View className="w-10 h-10 rounded bg-surface-container items-center justify-center"><Text className="text-primary font-bold">2</Text></View>
 <View className="flex-col">

...
export default function TeamSpace() {
 ...
 {/* Top AppBar */}
 <View className="w-full top-0 sticky z-40 bg-surface flex-row justify-between items-center h-16 px-margin-mobile ">
 ...
 {/* AI Insights */}
 <View className="flex-col lg:w-[65%] bg-white rounded-[24px] p-6 shadow-sm relative overflow-hidden">
 ...
 {/* Team Members */}
 <View className="flex-col flex-1 bg-white rounded-[24px] p-6 shadow-sm ">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="mt-4 pt-4 border-t items-center">
 ...
 <View className="border-l-2 pl-4 opacity-50">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-col flex-1">
 <View className="bg-surface-container-low rounded-2xl p-6 aspect-video flex-col justify-between mb-3">

...
export default function Billing() {
 ...
 <View className="bg-white rounded-2xl p-8 shadow-sm flex-col md:flex-row justify-between items-start md:items-center gap-6">
 ...
 <View className="flex-1 bg-surface-container-low rounded-xl p-6 shadow-sm flex-col">
 ...
 {/* Payment Method */}
 <View className="bg-white rounded-2xl p-8 shadow-sm flex-col">
 <Text className="font-headline-sm text-xl font-bold text-primary mb-6">Payment Method</Text>
 <View className="flex-row items-center justify-between p-4 rounded-xl bg-surface-bright">
 <View className="flex-row items-center gap-4">
 <View className="w-12 h-8 bg-surface-container rounded items-center justify-center">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="px-4 py-2 rounded-lg">

...
export default function FamilySpace() {
 ...
 <View className="w-full top-0 sticky z-50 bg-surface flex-row justify-between items-center h-16 px-margin-mobile ">
 ...
 <View className="flex-col lg:w-[65%] bg-white/70 rounded-[24px] p-6 shadow-sm relative overflow-hidden h-[450px]">
 ...
 {/* Simulated Nodes */}
 <View className="absolute top-20 left-10 bg-white p-3 rounded-xl shadow-lg flex-row items-center gap-2">
 <MaterialIcons name="home" size={20} color={colors.tertiary} />
 <Text className="text-sm font-medium">Summer House '98</Text>
 </View>
 <View className="absolute top-40 right-10 bg-white p-3 rounded-xl shadow-lg flex-row items-center gap-2">
 <MaterialIcons name="menu-book" size={20} color={colors.primary} />
 <Text className="text-sm font-medium">Grandma's Recipes</Text>
 </View>
 <View className="absolute bottom-20 left-[30%] bg-white p-3 rounded-xl shadow-lg flex-row items-center gap-2">
 ...
 {/* Shared Folders */}
 <View className="flex-col flex-1 bg-white/70 rounded-[24px] p-6 shadow-sm h-[450px]">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full mt-4 py-3 border-2 border-dashed rounded-xl items-center">
 ...
 {/* Memory Highlight */}
 <View className="flex-col md:w-[40%] bg-white/70 rounded-[24px] shadow-sm overflow-hidden">
 ...
 <View className="flex-col flex-1 bg-white/70 rounded-[24px] shadow-sm p-6">
 ...
 <View className="flex-col gap-8 pl-12 border-l-2 relative">

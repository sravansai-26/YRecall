...
export default function DiscoveryProfile() {
 ...
 {/* Top Navigation Bar */}
 <View className="w-full top-0 sticky z-50 bg-surface-container/80 shadow-sm h-16 px-4 md:px-margin-desktop flex-row justify-between items-center">
 ...
 <View className="relative w-full aspect-square rounded-xl overflow-hidden shadow-lg">
 ...
 <View className="pt-6 border-t flex-col gap-3">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full border-primary py-3 rounded-lg flex-row items-center justify-center gap-2">
 ...
 <View className="bg-surface-container-low rounded-2xl p-8 relative overflow-hidden">
 ...
 <View className="flex-1 w-full bg-surface-bright rounded-xl p-4 flex-row items-center justify-around">
 ...
 <View className="bg-white rounded-2xl p-8 shadow-sm relative h-[400px] flex-col">
 ...
 <View className="flex-1 relative rounded-xl bg-surface-dim/20 border-dashed overflow-hidden">
 <View className="absolute top-[20%] left-[30%] p-4 bg-white/70 rounded-full flex-row items-center gap-3 shadow-sm z-10 border-secondary/20">
 ...
 <View className="absolute top-[60%] left-[15%] p-3 bg-white/70 rounded-full flex-row items-center gap-3 shadow-sm z-10 border-secondary/20">
 <View className="w-2 h-2 bg-primary rounded-full" />
 <Text className="font-label-xs text-primary uppercase">API Architecture</Text>
 </View>
 <View className="absolute top-[40%] left-[70%] p-5 bg-white/70 rounded-full flex-row items-center gap-3 shadow-sm z-10 border-secondary/20">
 ...
 <View className="flex-1 bg-white p-6 rounded-xl shadow-sm">
 <View className="flex-row items-start justify-between mb-4">

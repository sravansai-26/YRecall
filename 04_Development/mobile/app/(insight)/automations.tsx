...
export default function AutomationsHub() {
 ...
 <View className="p-lg rounded-[24px] bg-white shadow-sm flex-col gap-lg">
 ...
 <View className="flex-col md:flex-row gap-lg">
 {/* Trigger */}
 <View className="flex-1 p-6 rounded-xl border-2 border-dashed bg-surface-container-low flex-col gap-4">
 ...
 {/* Action */}
 <View className="flex-1 p-6 rounded-xl bg-secondary-fixed/30 flex-col gap-4 relative">
 <View className="flex-row items-center gap-2">
 ...
 <View className="absolute bottom-4 right-4 flex-row items-center gap-2 bg-white px-2 py-1 rounded-full shadow-sm">
 ...
 {/* Execution Logs */}
 <View className="p-lg rounded-[24px] bg-white shadow-sm flex-col">
 <View className="flex-row justify-between items-center mb-6">
 <Text className="font-headline-md text-xl font-bold text-primary">Execution Logs</Text>
 <View className="flex-row gap-2">
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className=" px-3 py-1.5 rounded-lg ">
 ...
 {/* Table Header */}
 <View className="flex-row pb-3 mb-2">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="px-4 py-2 rounded-lg items-center justify-center">
 ...
 <View className="p-lg rounded-[24px] bg-surface shadow-sm h-[400px] flex-col">
 ...
 {/* Item 1 */}
 <View className="p-4 bg-white rounded-xl flex-row items-center justify-between">
 ...
 {/* Item 2 */}
 <View className="p-4 bg-white rounded-xl flex-row items-center justify-between opacity-70">
 <View className="flex-row items-center gap-3">
 <View className="w-10 h-10 rounded-full bg-surface-container flex items-center justify-center">
 ...
 {/* API Status Card */}
 <View className="p-6 rounded-[24px] bg-primary-container text-on-primary shadow-sm flex-col gap-4">
 ...
 {/* Key Manager Card */}
 <View className="p-6 rounded-[24px] bg-white shadow-sm flex-col gap-4">
 ...
 <View className="flex-row items-center justify-between bg-surface-container-low rounded-lg px-3 py-2">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full py-3 mt-2 border-outline rounded-xl items-center justify-center">

...
export default function InsightDetailContext() {
 ...
 <View className="bg-surface-container-lowest/80 p-lg rounded-[24px] shadow-sm relative overflow-hidden">
 ...
 <View className="flex-row items-start gap-4 bg-surface-container-low p-4 rounded-2xl ">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-1 flex-row items-center gap-4 p-4 bg-surface-container-lowest rounded-2xl shadow-sm">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-[2] h-14 bg-white border-secondary rounded-[16px] flex-row items-center justify-center gap-2 shadow-sm">

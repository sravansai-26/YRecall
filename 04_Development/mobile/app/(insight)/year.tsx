...
export default function YourYearInYRecall() {
 ...
 <View className="absolute bottom-6 left-6 bg-white/10 backdrop-blur-md p-4 rounded-xl border-white/10">
 ...
 <View className="absolute top-6 right-6 bg-white/10 backdrop-blur-md p-4 rounded-xl border-white/10">
 ...
 <View className="flex-[2] bg-surface-container-lowest/80 p-lg rounded-[24px] shadow-sm flex-col justify-between">
 <View>
 ...
 <View className="flex-[1.5] bg-surface-container-lowest/80 p-lg rounded-[24px] shadow-sm flex-col">
 ...
 <View className="h-64 flex-row items-end justify-between gap-2 px-2 pb-6 ">
 {/* Simple stacked bars */}
 ...
 <View className="flex-row justify-between items-center bg-white/60 p-3 rounded-lg border-white/80 shadow-sm">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="bg-white/10 py-4 px-8 rounded-full flex-row items-center justify-center gap-2 border-white/20">

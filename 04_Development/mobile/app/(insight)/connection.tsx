...
export default function InsightConnection() {
 ...
 <View className="flex-[2] bg-surface-container-lowest/80 p-lg rounded-[24px] shadow-sm relative overflow-hidden flex-col">
 ...
 <View className="flex-1 p-4 bg-surface-container-low rounded-xl ">
 ...
 <View className="bg-surface-container-highest p-6 rounded-[24px] flex-row items-center justify-between flex-1">
 <View>
 ...
 <View className="bg-surface-container-lowest/80 p-lg rounded-[24px] shadow-sm mt-2 flex-col">
 ...
 <View className="flex-[5] bg-surface-container-lowest/80 p-lg rounded-[24px] shadow-sm flex-col">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-row items-center gap-4 p-3 bg-surface-container-low rounded-xl ">
 ...
 <View className="bg-[#a3f69c]/20 border-[#a3f69c]/30 rounded-[24px] p-lg flex-1 shadow-sm relative overflow-hidden">
 ...
 <View className="flex-1 p-4 bg-white/40 rounded-xl border-[#003d0b]/10">

...
export default function LifeRecoveryDashboard() {
 ...
 <View className="flex-[2] bg-surface-container-lowest/80 border-error/20 p-lg rounded-[24px] shadow-sm relative overflow-hidden">
 ...
 <View className="bg-surface-container-low p-4 rounded-xl flex-1">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-1 py-3 border-outline rounded-xl items-center justify-center">
 ...
 {/* Health Status Card */}
 <View className="flex-[1] bg-surface-container-lowest/80 rounded-[24px] p-lg flex-col">
 ...
 <View className="flex-[1] bg-surface-container-lowest/80 rounded-[24px] p-lg">
 ...
 <View className="flex-row items-start gap-3 p-3 bg-surface-container-high rounded-xl ">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full py-3 border-secondary rounded-xl items-center justify-center">
 ...
 <View className="flex-[2] bg-surface-container-lowest/80 rounded-[24px] p-lg flex-col md:flex-row gap-6">
 ...
 <View className="flex-[1.5] border-t md:border-t-0 md:border-l pt-6 md:pt-0 md:pl-6">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="px-6 py-3 border-on-primary-container/30 rounded-full items-center justify-center">

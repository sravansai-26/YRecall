...
export default function RelationshipIntelligence() {
 ...
 <View className="flex-[2] bg-surface-container-lowest/80 rounded-[24px] overflow-hidden relative min-h-[400px] shadow-sm">
 ...
 {/* Simulated Tooltip */}
 <View className="absolute top-6 left-0 bg-surface-container-lowest/90 p-3 rounded-xl w-48 shadow-lg z-20 ">
 ...
 {/* Graph Legend */}
 <View className="absolute bottom-6 right-6 flex-row gap-4 bg-surface-container-lowest/90 p-4 rounded-xl shadow-sm">
 ...
 <View className=" bg-surface-container-lowest/80 rounded-[24px] p-6 shadow-sm flex-col">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-row items-center gap-3 p-2 rounded-xl ">
 <View className="w-10 h-10 rounded-full bg-surface-container-highest overflow-hidden">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="mt-6 w-full py-3 rounded-xl items-center justify-center">
 <Text className="font-bold text-label-xs uppercase tracking-widest text-on-surface">Recall All</Text>
 </TouchableOpacity>
 </View>

 {/* AI Intro Suggestions */}
 <View className=" bg-surface-container-lowest/80 rounded-[24px] p-6 shadow-sm">
 <Text className="font-bold text-[10px] text-on-surface-variant uppercase tracking-widest mb-4">AI Intro Suggestions</Text>
 
 <View className="p-4 bg-[#a3f69c]/20 rounded-xl ">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="px-3 rounded-lg items-center justify-center bg-surface-container-highest">
 ...
 {/* Network Pulse */}
 <View className=" bg-primary text-white rounded-[24px] p-6 shadow-sm">

...
export default function ProactiveExecutionHub() {
 ...
 {/* Action Card: Health */}
 <View className="bg-surface-container-lowest p-lg rounded-[24px] flex-col md:flex-row gap-6 shadow-sm">
 ...
 <View className="h-48 w-full md:w-48 bg-surface-container rounded-xl overflow-hidden mt-4 md:mt-0">
 <Image 
 ...
 <View className="h-48 w-full md:w-48 bg-surface-container rounded-xl overflow-hidden relative mt-4 md:mt-0">
 <Image 
 ...
 <View className="flex-1 bg-surface-container-low p-lg rounded-[24px] ">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="w-full mt-4 py-4 border-white/20 rounded-xl items-center justify-center bg-white/5">
 ...
 {/* Feedback Loop */}
 <View className="bg-surface-container-high p-lg rounded-[24px] ">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-1 py-4 bg-surface-container-lowest rounded-xl items-center justify-center shadow-sm">

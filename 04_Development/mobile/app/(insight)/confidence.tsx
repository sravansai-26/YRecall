...
export default function SourceAttribution() {
 ...
 <View className="p-lg flex-col md:flex-row justify-between items-start md:items-center gap-4">
 ...
 {/* Card 1 */}
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="bg-surface p-lg rounded-[24px] transition-colors group">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="bg-surface p-lg rounded-[24px] transition-colors group flex-col gap-6 h-full">
 ...
 <View className="p-4 bg-surface-container-lowest rounded-xl flex-row gap-4">
 <View className="pt-1">
 ...
 <TouchableOpacity onPress={() => require('react-native').Alert.alert('Coming Soon', 'Backend integration pending')} className="flex-1 md:flex-none border-on-primary-container py-3 px-6 rounded-full flex-row items-center justify-center gap-2">

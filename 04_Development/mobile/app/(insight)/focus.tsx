...
export default function FocusAndProductivity() {
 ...
 {/* Clock Face Visual */}
 <View className="w-64 h-64 md:w-80 md:h-80 rounded-full flex items-center justify-center relative">
 ...
 {/* Central Indicator */}
 <View className="items-center justify-center bg-surface-container-lowest w-24 h-24 rounded-full shadow-sm z-10">
 ...
 {/* Recall Speed Chart */}
 <View className="flex-[1] bg-surface-container-lowest/80 p-lg rounded-[24px] shadow-sm flex-col">
 <View className="mb-6">
 ...
 <View className="flex-1 min-h-[200px] flex-row items-end gap-2 px-2 pb-4 ">
 ...
 <View className="bg-surface-container-lowest/80 p-lg rounded-[24px] shadow-sm flex-col">
 ...
 <View className="flex-1 bg-surface-container-lowest/80 p-6 rounded-[24px] flex-row items-center gap-6 shadow-sm">

...
export default function SemanticClusters() {
 ...
 {/* Connection Heatmap */}
 <View className="flex-[2] bg-surface-container-lowest/80 p-lg rounded-[24px] shadow-sm flex-col">
 ...
 <View className="flex-row justify-between items-center mt-auto border-t pt-4">
 ...
 {/* Top Clusters */}
 <View className="bg-surface-container-lowest/80 p-lg rounded-[24px] shadow-sm flex-1">
 ...
 {/* Simple Chart Representation using bottom shape */}
 <View className="h-48 relative flex-row items-end justify-between px-2 pb-8">
 ...
 <View className="flex-1 bg-surface-container-lowest/80 p-lg rounded-[24px] flex-col justify-center shadow-sm">

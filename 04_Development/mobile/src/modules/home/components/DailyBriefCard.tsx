...
export function DailyBriefCard({ summary, date, metrics, priorities, isLoading }: Props) {
 if (isLoading) {
 return (
 <View className="bg-surface-container-low rounded-3xl p-5 mb-5 shadow-sm ">
 ...
 if (!summary) {
 return (
 <View className="bg-surface-container-low rounded-3xl p-5 mb-5 shadow-sm flex-row items-center gap-3">

...
export function QuickCaptureWidget({ widgetInfo }: { widgetInfo: any }) {
    return (
        <FlexWidget
            style={{ height: "match_parent", width: "match_parent", backgroundColor: '#FFF8F1', borderRadius: 16, padding: 12, justifyContent: 'space-between' }}
        >
            <FlexWidget style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: 'match_parent' }}>
                <TextWidget text="Capture" style={{ fontSize: 14, fontWeight: 'bold', color: '#1A1C1E' }} />
                <ImageWidget image={require('../../../../assets/logos/yr-logo-widget.png')} imageWidth={18} imageHeight={18} style={{ width: 18, height: 18 }} />
            </FlexWidget>

            <FlexWidget style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', flex: 1, marginTop: 12, width: 'match_parent' }}>

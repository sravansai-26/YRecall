...
export default function AIBentoCard({
 ...
 return (
 <View className={`bg-white rounded-[24px] p-lg shadow-sm flex-col ${containerClassName}`} style={style}>
 ...
 {actionText && (
 <TouchableOpacity 
 className="mt-6 pt-4 border-t flex-row items-center justify-between"

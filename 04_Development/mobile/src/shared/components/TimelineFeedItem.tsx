...
export function TimelineFeedItem({
 ...
 if (type === 'voice-memo') {
 return (
 <View className="flex-1 bg-white rounded-[24px] p-6 shadow-sm ">
 ...
 {content && (
 <View className="p-md bg-surface-container-lowest rounded-xl mb-4">
 ...
 if (type === 'photo') {
 return (
 <View className="flex-1 bg-white rounded-[24px] overflow-hidden shadow-sm ">
 <View className="p-lg">
